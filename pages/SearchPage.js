...
exports.SearchPage = class SearchPage{
    ...
    constructor(page){
        this.page = page;
        this.TVcardLocator = page.locator("//a[@class='goods-tile__picture ng-star-inserted']");
        this.ProductLocator = page.locator("[aria-label='Купить']");
        this.ProductCardLocator = page.locator("//div[@class='goods-tile__inner']");
        this.buyProductButtonLocator = page.locator("#icon-basket");
        this.buyTabletButtonLocator = page.locator('body > app-root > div > div > rz-category > div > main > rz-catalog > div > div > section > rz-grid > ul > li:nth-child(1) > rz-catalog-tile > app-goods-tile-default > div > div.goods-tile__inner > div.goods-tile__prices > div.goods-tile__price.price--red.ng-star-inserted > app-buy-button > button > svg');
        ...
        this.downMenuSortedLocator = page.locator("select-css ng-pristine ng-valid ng-star-inserted ng-touched");
        this.sortedFromCheapToExpensiveLocator = page.locator("//option[text()='От дешевых к дорогим']");
